...
const sorular = [
  ...
  { id: 't_mes_1', k: 'Mesleki ve Periyodik İşitme Taraması', y: 'tum', t: 'tum', s: 'İş yerinizde gün boyunca sürekli veya kesintili olarak yüksek sese maruz kalıyor musunuz?', o: ['Evet, sürekli', 'Evet, bazen', 'Hayır'] },
  { id: 't_mes_2', k: 'Mesleki ve Periyodik İşitme Taraması', y: 'tum', t: 'tum', s: 'Çalışırken kulak tıkacı, manşon veya benzeri bir koruyucu ekipman kullanıyor musunuz?', o: ['Evet, her zaman', 'Bazen', 'Hayır, hiç kullanmıyorum'] },
  { id: 't_mes_3', k: 'Mesleki ve Periyodik İşitme Taraması', y: 'tum', t: 'tum', s: 'İş bitiminde veya mesai çıkışında kulaklarınızda çınlama, uğultu veya tıkanıklık hissediyor musunuz?', o: ['Evet', 'Hayır'] },
  { id: 't_mes_4', k: 'Mesleki ve Periyodik İşitme Taraması', y: 'tum', t: 'tum', s: 'Daha önceki periyodik muayenelerde (varsa) işitme kaybı tespit edildi mi?', o: ['Evet', 'Hayır', 'İlk defa test yaptırıyorum'] }
